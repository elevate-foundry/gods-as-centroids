...
def map_anchor(text: str, default: str) -> str:
    ...
    mappings = {
        ...
        '4.5 Lattice Hysteresis': 'lattice-hysteresis',
        ...
        '5.5 The 8-Dot Extension': 'eight-dot',
        '6. Historical Backtesting': 'backtesting',
        '7. Discussion': 'discussion',
        '8. Corpus': 'corpus-calibration',
        '8.1 Empirical': 'empirical-priors',
        '8.2 Multi-LLM': 'inter-scorer',
        '8.3 Consensus': 'consensus-params',
        '8.4 4-LLM Lattice': 'lattice-consensus',
